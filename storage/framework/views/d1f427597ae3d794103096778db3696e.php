    ...
    <div class="adm-sidebar-top">
        ...
        <nav class="adm-nav">
            <a href="<?php echo e(url('/admin-dashboard')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin-dashboard*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.history')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin/history*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('admin.meja.index')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin/meja*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?php echo e(route('admin.stock.index')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin/stock*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path
            ...
            <a href="<?php echo e(route('admin.akun.index')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin/akun*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.laporan')); ?>"
                class="adm-nav-link <?php echo e(Request::is('admin/laporan*') ? 'active' : ''); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<script src="<?php echo e(asset('js/js_component/mobile_menu.js')); ?>"></script><?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/component/c_dashboard/sidebar/sidebar_admin.blade.php ENDPATH**/ ?>