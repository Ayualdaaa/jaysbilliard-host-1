...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/css_page/css_interaksi page/buat_meja.css')); ?>">
</head>
<body>
            ...
            <div class="adm-content">
                <div class="adm-content-header">
                    <div class="adm-breadcrumb">
                        <a href="<?php echo e(url('/admin-dashboard')); ?>" class="adm-breadcrumb-back">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.meja.store')); ?>" method="POST" enctype="multipart/form-data" id="mejaForm">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="adm-card">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="nameInput" class="form-input <?php $__errorArgs = ['name'];
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/dashboard_admin/meja/buat_meja.blade.php ENDPATH**/ ?>