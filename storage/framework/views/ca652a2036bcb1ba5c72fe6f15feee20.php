        ...
        <?php else: ?>
            ...
            <div class="adm-notif-bell-wrap" style="position: relative;">
                ...
                <div id="notifDropdown" style="display: none; position: absolute; top: 45px; right: 0; width: 320px; background: #1a1a1e; border: 1px solid #333; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); z-index: 1000; padding: 15px; color: #fff;">
                    ...
                    <a href="<?php echo e((auth()->check() && auth()->user()->role === 'admin') ? route('admin.history') : route('user.history')); ?>" style="display: block; text-align: center; margin-top: 15px; padding-top: 10px; border-top: 1px solid #333; color: #00e5ff; font-size: 0.8rem; text-decoration: none; font-weight: 600;">Lihat Semua Riwayat</a>
                </div>
            </div>
            ...
            <div class="adm-user-profile-wrap">
                <div class="adm-user-badge" id="profileBtn">
                    <div class="adm-user-avatar"><?php echo e(strtoupper(substr((Request::is('admin*') || Request::is('admin-dashboard*')) ? 'Admin' : (auth()->user()->name ?? 'User'), 0, 1))); ?></div>
