        ...
        <main class="adm-main">
            ...
            <div class="adm-content">
                ...
                <div class="adm-form-card">
                    <form action="<?php echo e(route('admin.akun.update', $user->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" style="margin-top: 2.5rem; padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.05);">
                            ...
                            <?php endif; ?>
                            <div class="role-options" <?php if(auth()->id() === $user->id): ?> style="opacity: 0.6; pointer-events: none;" <?php endif; ?>>
                                <label class="role-opt">
                                    <input type="radio" name="role" value="user" <?php echo e((old('role', $user->role) === 'user') ? 'checked' : ''); ?>>
                                    <div class="icon">
                                ...
                                <label class="role-opt">
                                    <input type="radio" name="role" value="admin" <?php echo e((old('role', $user->role) === 'admin') ? 'checked' : ''); ?>>
                                    <div class="icon">
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/dashboard_admin/akun/edit_akun.blade.php ENDPATH**/ ?>