<nav class="fixed top-0 w-full z-50 bg-[#0d0d0d]/90 backdrop-blur border-b border-white/5">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#0d0d0d]/95 border-t border-white/5 px-6 py-4 space-y-4">
        <a href="<?php echo e(route('home')); ?>" class="block text-sm font-bold <?php echo e(request()->routeIs('home') ? 'text-[#00e5ff]' : 'text-gray-300 hover:text-white'); ?> transition">Beranda</a>
        <a href="<?php echo e(route('rates')); ?>" class="block text-sm font-bold <?php echo e(request()->routeIs('rates') ? 'text-[#00e5ff]' : 'text-gray-300 hover:text-white'); ?> transition">Tarif</a>
        <a href="<?php echo e(route('location')); ?>" class="block text-sm font-bold <?php echo e(request()->routeIs('location') ? 'text-[#00e5ff]' : 'text-gray-300 hover:text-white'); ?> transition">Lokasi</a>
        <div class="pt-4 border-t border-white/5 flex flex-col gap-3">
            <a href="<?php echo e(route('login')); ?>" class="text-center border border-[#00e5ff] text-[#00e5ff] text-sm font-bold px-5 py-2 rounded-md hover:bg-[#00e5ff] hover:text-black transition">
                Login
            </a>
            <a href="<?php echo e(route('register')); ?>" class="text-center bg-[#00e5ff] text-black text-sm font-bold px-5 py-2 rounded-md hover:bg-[#00cce6] shadow-md transition">
                Register
            </a>
        </div>
    </div>
...
</script><?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/component/c_website/navbar.blade.php ENDPATH**/ ?>