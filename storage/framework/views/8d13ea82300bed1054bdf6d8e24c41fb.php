            ...
            <div class="adm-content adm-akun-content">
                ...
                <?php if(session('error')): ?>
                    <div class="adm-alert adm-alert--error" style="margin-bottom: 2rem; background: rgba(255, 59, 59, 0.1); border: 1px solid rgba(255, 59, 59, 0.2); border-radius: 12px; padding: 15px; display: flex; align-items: center; gap: 15px;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 0.85rem; color: rgba(255,255,255,0.7); margin-top: 2px;"><?php echo e(session('error')); ?></div>
                        </div>
                ...
                <div class="adm-akun-header">
                    ...
                    <div class="adm-akun-actions">
                        <a href="<?php echo e(route('admin.akun.create')); ?>" class="adm-btn-add">
                    ...
                    <table class="adm-table" id="usersTable">
                        ...
                        <tbody>
                            ...
                            <tr class="user-row">
                                ...
                                <td style="font-family: monospace; color: rgba(255,255,255,0.7);"><?php echo e($user->username); ?></td>
                                <td><?php echo e($user->phone ?: '-'); ?></td>
                                <td>
                                    <span class="role-badge role-<?php echo e($user->role); ?>"><?php echo e($user->role); ?></span>
                                </td>
                                ...
                                <td>
                                    <div class="action-btns">
                                        <a href="<?php echo e(route('admin.akun.edit', $user->id)); ?>" class="btn-action">
                                        ...
                                        <form action="<?php echo e(route('admin.akun.destroy', $user->id)); ?>" method="POST" style="display:inline;">
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/dashboard_admin/akun/index.blade.php ENDPATH**/ ?>