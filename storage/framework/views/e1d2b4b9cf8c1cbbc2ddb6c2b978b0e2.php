...
<div class="history-container">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <span class="stat-value"><?php echo e($totalHistory); ?></span>
        </div>
        <div class="stat-card">
            <span class="stat-label">BOOKING MEJA</span>
            <span class="stat-value"><?php echo e($totalBookings); ?></span>
        </div>
        <div class="stat-card">
            <span class="stat-label">PESANAN F&B</span>
            <span class="stat-value"><?php echo e($totalFnb); ?></span>
        </div>
    </div>
    ...
    <div class="main-card">
        ...
        <div class="history-list">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $allItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php if($item->type === 'meja'): ?>
                    <?php $booking = $item->data; ?>
                    <div class="history-item" data-type="meja" data-search="<?php echo e(strtolower('booking meja ' . ($booking->table->name ?? ''))); ?> bkg-<?php echo e($booking->id); ?>">
                        <div class="item-header">
                            <span class="type-badge">BOOKING MEJA</span>
                            <span class="status-badge <?php echo e($booking->status === 'confirmed' || $booking->status === 'completed' || $booking->status === 'paid' ? '' : 'status-pending'); ?>">
                                <?php echo e(in_array($booking->status, ['confirmed', 'paid']) ? 'BERHASIL' : ($booking->status === 'completed' ? 'SELESAI' : strtoupper($booking->status))); ?>
                        ...
                        <div class="item-id">
                            ...
                            ID: BKG-<?php echo e($booking->id); ?>

                        </div>
                        
                        <h3 class="item-title">Booking <?php echo e(ucwords($booking->table->name ?? 'Meja')); ?></h3>
                        
                        <div class="item-details">
                            <div class="detail-row">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                <?php echo e(\Carbon\Carbon::parse($booking->booking_date)->format('d M Y')); ?>, <?php echo e(\Carbon\Carbon::parse($booking->start_time)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->end_time)->format('H:i')); ?> WIB
                            </div>
                            <div class="detail-row">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                                Durasi <?php echo e(\Carbon\Carbon::parse($booking->start_time)->diffInHours(\Carbon\Carbon::parse($booking->end_time))); ?> Jam
                            </div>
                            <div class="detail-row">
                                ...
                                <?php echo e(strtoupper(str_replace('_', ' ', $booking->payment_method ?? '-'))); ?>
                ...
                <?php else: ?>
                    <?php $order = $item->data; ?>
                    <div class="history-item" data-type="fnb" data-search="<?php echo e(strtolower('pesanan f&b ' . $order->order_id)); ?> <?php echo e(strtolower($order->order_id)); ?>">
                        <div class="item-header">
                            <span class="type-badge type-badge-fnb">PESANAN F&B</span>
                            <span class="status-badge <?php echo e($order->status === 'paid' ? '' : 'status-pending'); ?>">
                                <?php echo e($order->status === 'paid' ? 'BERHASIL' : 'PENDING'); ?>
                        ...
                        <div class="item-details">
                            <div class="detail-row">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                <?php echo e(\Carbon\Carbon::parse($order->created_at)->timezone('Asia/Jakarta')->format('d M Y, H:i')); ?> WIB
                            </div>
                            <div class="detail-row">
                                ...
                                <?php echo e($order->details->sum('quantity')); ?> Item
                            </div>
                            <div class="detail-row">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                                <?php echo e(strtoupper(str_replace('_', ' ', $order->payment_method ?? '-'))); ?> (Antar ke: <?php echo e(strtoupper($order->booking->table->name ?? 'Meja')); ?>)
                            </div>
                        </div>
                        
                        <div class="item-price">
                            Rp <?php echo e(number_format($order->total_price_fnb, 0, ',', '.')); ?>
