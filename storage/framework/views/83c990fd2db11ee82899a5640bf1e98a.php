        ...
        <main class="adm-main">
            ...
            <div class="adm-content">
                <div class="adm-breadcrumb" style="margin-bottom: 2rem; display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; font-weight: 700; color: rgba(255,255,255,0.4);">
                    <a href="<?php echo e(route('admin.akun.index')); ?>" style="color: #00e5ff; text-decoration: none;">Kelola Akun</a>
                    <span>•</span>
                    <span style="color: #fff;">Buat Akun</span>
                </div>

                <div class="adm-form-card">
                    <form action="<?php echo e(route('admin.akun.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="Contoh: John Doe" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('username')); ?>" placeholder="Contoh: johndoe" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" placeholder="Contoh: john@example.com" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('phone')); ?>" placeholder="Contoh: 08123456789">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            <a href="<?php echo e(route('admin.akun.index')); ?>" class="btn-cancel">BATAL</a>
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/dashboard_admin/akun/buat_akun.blade.php ENDPATH**/ ?>