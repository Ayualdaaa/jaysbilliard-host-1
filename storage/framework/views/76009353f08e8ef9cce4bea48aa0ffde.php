            ...
            <div class="adm-content adm-history-content">
                ...
                <div class="adm-history-stats">
                    <div class="adm-hstat-card">
                        ...
                        <div class="adm-hstat-info">
                            ...
                            <span class="adm-hstat-value" id="statTotalIncome">Rp <?php echo e(number_format(collect($transactions)->whereIn('status', ['paid', 'completed', 'confirmed', 'booked', 'payment', 'lunas', 'selesai'])->sum('total_price'), 0, ',', '.')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="adm-hstat-card">
                        ...
                        <div class="adm-hstat-info">
                            ...
                            <span class="adm-hstat-value" id="statTodayCount"><?php echo e(collect($transactions)->whereIn('status', ['paid', 'completed', 'confirmed', 'booked', 'payment', 'lunas', 'selesai'])->count()); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="adm-hstat-card">
                        ...
                        <div class="adm-hstat-info">
                            ...
                            <span class="adm-hstat-value" id="statFailedCount"><?php echo e(collect($transactions)->whereNotIn('status', ['paid', 'completed', 'confirmed', 'booked', 'payment', 'lunas', 'selesai', 'pending'])->count()); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="adm-history-actions" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                    ...
                    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
                        <form action="<?php echo e(route('admin.laporan')); ?>" method="GET" style="display: flex; gap: 8px; align-items: center;">
                    ...
                    <div class="adm-table-scroller">
                        <table class="adm-table" id="transactionTable">
                            ...
                            <tbody id="transactionBody">
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-customer">
                                                <div class="cust-avatar" style="background: #00bcd4;"><?php echo e($initial); ?></div>
                                                <span class="cust-name"><?php echo e($item->customer_name); ?></span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="method-badge" style="background: rgba(0, 229, 255, 0.05); color: #00e5ff; border-color: rgba(0, 229, 255, 0.2);">
                                                <?php echo e($hasFnb ? 'Booking + F&B' : 'Booking Meja'); ?>

                                            </span>
                                        </td>
                                        <td><span class="method-badge"><?php echo e($item->payment_method ?? 'QRIS'); ?></span></td>
                                        <td>
                                            <span class="date-primary"><?php echo e(\Carbon\Carbon::parse($item->booking_date)->format('d M Y')); ?></span>
                                            <span class="time-secondary"><?php echo e(\Carbon\Carbon::parse($item->start_time)->format('H:i')); ?></span>
                                        </td>
                                        <td><span class="<?php echo e($amountClass); ?>">Rp <?php echo e(number_format($item->total_price, 0, ',', '.')); ?></span></td>
                                        <td><?php echo $statusHtml; ?></td>
                                        <td class="col-action">
                                            <div class="adm-action-buttons">
                                                <button type="button" class="btn-action view" style="background: transparent; color: #ffb300;" onclick='showOrderDetails("<?php echo e(htmlspecialchars($item->customer_name, ENT_QUOTES)); ?>", "<?php echo e(\Carbon\Carbon::parse($item->booking_date)->format('d M Y')); ?>", "<?php echo e(\Carbon\Carbon::parse($item->start_time)->format('H:i')); ?>", "<?php echo e($item->table->name ?? 'N/A'); ?>", "<?php echo e($item->payment_method ?? 'QRIS'); ?>", "<?php echo e($duration); ?>", <?php echo json_encode($allDetails); ?>, "Rp <?php echo e(number_format($item->total_price, 0, ',', '.')); ?>")' title="View Transaction">
...
<?php /**PATH C:\laragon\www\jaysbilliard-main\resources\views/dashboard_admin/laporan.blade.php ENDPATH**/ ?>